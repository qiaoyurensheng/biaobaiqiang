...
<div class="wrap">
	<div class="share">
	<span class="hh1"><?php echo ($data["towho"]); ?>，这是我的真爱宣言：</span><br/>
	<p><?php echo ($data["content"]); ?></p></br>
	<!--<span class="ff1">by：<?php echo ($data["realname"]); ?><img src="http://gravatar.duoshuo.com/avatar/<?php echo (md5($vo["email"])); ?>" alt=""></span>-->
</div>
<br />
<!-- UY BEGIN -->
<div id="uyan_frame"></div>
<script type="text/javascript" src="http://v2.uyan.cc/code/uyan.js?uid=2129900"></script>
<!-- UY END -->
